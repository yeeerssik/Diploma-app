    ...
    return (
        <div className='template1-parent'>
            ...
            <div className='objective mt-3'>
                <h3 style={{backgroundColor:'gray', padding:5, color:'white'}}>О себе</h3>
                <hr />
            ...
            <div className='education mt-2'>
                <h3 style={{backgroundColor:'gray', padding:5, color:'white'}}>Образование</h3>
                <hr />
                {user.education.map((education: any) => {
            ...
            <div className='experience mt-2'>
                <h3 style={{backgroundColor:'gray', padding:5, color:'white'}}>Опыт работы</h3>
                <hr />
            ...
            <div className='projects mt-2'>
                <h3 style={{backgroundColor:'gray', padding:5, color:'white'}}>Проекты</h3>
                <hr />
            ...
            <div className='skills mt-3'>
                <h3 style={{backgroundColor:'gray', padding:5, color:'white'}}>Навыки</h3>
                <hr />
